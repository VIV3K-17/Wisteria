...
const features = [{
  icon: MapPin,
  title: 'Live Tracking',
  desc: 'Real-time GPS-based journey monitoring'
}, {
  icon: Shield,
  title: 'Safety Checks',
  desc: 'Checkpoint-based safety verification'
}, {
  icon: Bell,
  title: 'Smart Alerts',
  desc: 'Auto-alert emergency contacts if needed'
}];
const Index = () => {
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        delay: 0.5
          ...
          <Button onClick={() => navigate('/signup')} className="w-full gradient-primary text-primary-foreground rounded-2xl h-14 font-semibold text-base soft-shadow">
            Get Started
            <ArrowRight className="w-5 h-5 ml-2" />
          </Button>
          <Button onClick={() => navigate('/login')} variant="outline" className="w-full rounded-2xl h-14 font-semibold text-base border-primary text-primary">
            Sign In
          </Button>
        </motion.div>

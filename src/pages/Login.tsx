    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">SafeTravel</h1>
        ...
        <div className="glass-card rounded-2xl p-6 soft-shadow">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full gradient-primary text-primary-foreground rounded-xl h-12 font-semibold text-base"
            >
